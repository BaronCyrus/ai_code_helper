...
import com.github.baroncyrus.aicodehelper.pojo.PromptInfo;
...
@State(name = "com.github.baroncyrus.aicodehelper.settings.ApiKeySettings", storages = { @Storage("AICodeAssistSettings.xml") })
public class ApiKeySettings implements PersistentStateComponent<ApiKeySettings> {
    private String selectedClient = "DeepSeek";
    private String selectedModule = "deepseek-chat";
